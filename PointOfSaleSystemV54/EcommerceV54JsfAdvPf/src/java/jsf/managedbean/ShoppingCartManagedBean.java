...
public class ShoppingCartManagedBean implements Serializable {
    ...
    public void addLineItem(ActionEvent event) {
        ...
        System.out.println("Product id: " + lineItem.getProductEntity().getProductId());
        System.out.println("Quantity ordered: " + lineItem.getQuantity());
    ...
    public void updateQuantityForShoppingCartItem(ActionEvent event) {
        System.out.println(">>>>> updateQuantityForShoppingCartItem");
        ...
        System.out.println("New quantity ordered: " + lineItemToUpdate.getQuantity());
        ...
        if (lineItemToUpdate.getQuantity() > 0) {
            ...
            System.out.println("Line Item remove");
    ...
    public void doCheckoutForCustomer(ActionEvent event) throws CustomerNotFoundException, CreateNewSaleTransactionException {
        ...
        System.out.println(">>>>>>>> Sale Transaction created");
        clearShoppingCart();
    }
